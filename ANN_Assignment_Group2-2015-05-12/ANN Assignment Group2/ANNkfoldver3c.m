...
mu_dec  =  0.001;
mu_inc  =  100;
mu_max  =  1000000000000;
show_window  =  false;
showCommandLine=true;

trainRatio = 0.7; %data split ratio for training
valRatio = 0.15; %data split ratio for validation
testRatio = 0.15;  %data not split for test as 10-fold cross validation is implemented

load emotions_data2; %emotions_data(448 samples), emotions_data2(612 samples)
